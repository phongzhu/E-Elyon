        ...
        <main className="flex-1 p-8 overflow-y-auto">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              <StatCard icon={<DollarSign size={22} style={{ color: primaryColor }} />} label="Total Donations" value={agg.income} subtitle="Tithes, Offerings & Gifts" />
                          ...
                          <div className={`p-4 rounded-lg border ${
                            ...
                            <div className="flex items-center justify-between">
                              <div>
                                ...
                                <p className="text-xs text-gray-600 mt-1">
                                  {((agg.expenses / agg.income) * 100).toFixed(1)}% of donations spent
                                </p>
                              </div>
                              <span className={`text-xs font-semibold px-3 py-1 rounded-full ${
                                (agg.expenses / agg.income) > 0.8
                                ...
                                {(agg.expenses / agg.income) > 0.8 ? "High" : "Healthy"}
                              </span>
                            </div>
                          </div>
                        )}
